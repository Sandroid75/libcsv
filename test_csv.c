...
void test_parser(char *test_name, unsigned char options, void *input, size_t len, struct event expected[],
...
int main(void)
{
  ...
  */
	...
	/* |1|2|3|4|5| */
	struct event test01_results[] = { { CSV_COL, 0, 1, "1" },
		                              { CSV_COL, 0, 1, "2" },
		                              { CSV_COL, 0, 1, "3" },
		                              { CSV_COL, 0, 1, "4" },
		                              { CSV_COL, 0, 1, "5" },
	...
	/* ||||||| */
	struct event test02_results[] = { { CSV_COL, 0, 0, "" },
		                              { CSV_COL, 0, 0, "" },
		                              { CSV_COL, 0, 0, "" },
		                              { CSV_COL, 0, 0, "" },
		                              { CSV_COL, 0, 0, "" },
	...
	/* |,|,|| */
	struct event test03_results[] = { { CSV_COL, 0, 1, "," },
		                              { CSV_COL, 0, 1, "," },
		                              { CSV_COL, 0, 0, "" },
		                              { CSV_ROW, -1, 1, NULL },
		                              { CSV_END, 0, 0, NULL } };

	struct event test04_results[] = { { CSV_COL, 0, 147, "I call our world Flatland,\x0a"
		                                                 "not because we call it so,\x0a"
		                                                 "but to make its nature clearer\x0a"
		                                                 "to you, my happy readers,\x0a"
		                                                 "who are privileged to live in Space." },
	...
	/* |"a,b"|| "" |"" | ""|""| */
	struct event test05_results[] = { { CSV_COL, 0, 5, "\"a,b\"" },
		                              { CSV_COL, 0, 0, "" },
		                              { CSV_COL, 0, 4, " \"\" " },
		                              { CSV_COL, 0, 3, "\"\" " },
		                              { CSV_COL, 0, 3, " \"\"" },
	...
	/* | a, b ,c |a b  c|| */
	struct event test06_results[] = { { CSV_COL, 0, 9, " a, b ,c " },
		                              { CSV_COL, 0, 6, "a b  c" },
		                              { CSV_COL, 0, 0, "" },
		                              { CSV_ROW, -1, 1, NULL },
		                              { CSV_END, 0, 0, NULL } };
	...
	/* | " " " " | */
	struct event test07_results[] = { { CSV_COL, 0, 9, " \" \" \" \" " },
		                              { CSV_ROW, -1, 1, NULL },
		                              { CSV_END, 0, 0, NULL } };

	/* Will cause error with CSV_STRICT set */
	struct event test07b_results[] = { { CSV_ERR, 0, 0, NULL } };

	struct event test08_results[] = { { CSV_COL, 0, 463, " abc\"                                               "
		                                                 "                                                     "
		                                                 "                                                     "
		                                                 "                                                     "
		                                                 "                                                     "
	...
	/* empty */
	struct event test09_results[] = { { CSV_END, 0, 0, NULL } };

	/* |a| */
	struct event test10_results[] = { { CSV_COL, 0, 1, "a" },
		                              { CSV_ROW, '\x0a', 1, NULL },
		                              { CSV_END, 0, 0, NULL } };

	/* |1|2|3|4| */
	struct event test11_results[] = { { CSV_COL, 0, 1, "1" },
		                              { CSV_COL, 0, 1, "2" },
		                              { CSV_COL, 0, 1, "3" },
		                              { CSV_COL, 0, 1, "4" },
		                              { CSV_ROW, '\x0a', 1, NULL },
	...
	/* empty */
	struct event test12_results[] = { { CSV_END, 0, 0, NULL } };

	/* Test CSV_REPALL_NL */
	struct event test12b_results[] = { { CSV_ROW, '\x0a', 1, NULL },
		                               { CSV_ROW, '\x0a', 1, NULL },
		                               { CSV_ROW, '\x0a', 1, NULL },
		                               { CSV_ROW, '\x0a', 1, NULL },
		                               { CSV_END, 0, 0, NULL } };
	...
	/* |abc| */
	struct event test13_results[] = { { CSV_COL, 0, 3, "abc" },
		                              { CSV_ROW, -1, 1, NULL },
		                              { CSV_END, 0, 0, NULL } };
	...
	/* |1|2|3||
     |4||
     |||       */
	struct event test14_results[] = { { CSV_COL, 0, 1, "1" },
		                              { CSV_COL, 0, 1, "2" },
		                              { CSV_COL, 0, 1, "3" },
		                              { CSV_COL, 0, 0, "" },
		                              { CSV_ROW, '\x0a', 1, NULL },
	...
	/* |1|2|3||
     |4||
     ||       */
	struct event test15_results[] = { { CSV_COL, 0, 1, "1" },
		                              { CSV_COL, 0, 1, "2" },
		                              { CSV_COL, 0, 1, "3" },
		                              { CSV_COL, 0, 0, "" },
		                              { CSV_ROW, '\x0a', 1, NULL },
	...
	/* |1|2| 3 | */
	struct event test16_results[] = { { CSV_COL, 0, 1, "1" },
		                              { CSV_COL, 0, 1, "2" },
		                              { CSV_COL, 0, 3, " 3 " },
		                              { CSV_ROW, -1, 1, NULL },
		                              { CSV_END, 0, 0, NULL } };
	...
	struct event test16b_results[] = { { CSV_COL, 0, 1, "1" },
		                               { CSV_COL, 0, 1, "2" },
		                               { CSV_ERR, 0, 0, NULL } };

	/* |a\0b\0c| */
	struct event test17_results[] = { { CSV_COL, 0, 5, "a\0b\0c" },
		                              { CSV_ROW, -1, 1, NULL },
		                              { CSV_END, 0, 0, NULL } };

	/* Test CSV_EMPTY_IS_NULL */
	struct event test19_results[] = { { CSV_COL, 0, 0, NULL },
		                              { CSV_COL, 0, 0, "" },
		                              { CSV_COL, 0, 0, NULL },
		                              { CSV_ROW, -1, 1, NULL },
		                              { CSV_END, 0, 0, NULL } };
	...
	/* |'a;b'|| '' |'' | ''|''| */
	struct event custom01_results[] = { { CSV_COL, 0, 5, "'a;b'" },
		                                { CSV_COL, 0, 0, "" },
		                                { CSV_COL, 0, 4, " '' " },
		                                { CSV_COL, 0, 3, "'' " },
		                                { CSV_COL, 0, 3, " ''" },
